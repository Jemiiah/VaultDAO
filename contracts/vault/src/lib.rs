...
use types::{
    Comment, Condition, ConditionLogic, Config, Dispute, DisputeResolution, DisputeStatus,
    GasConfig, InsuranceConfig, ListMode, NotificationPreferences, Priority, Proposal,
    ProposalStatus, Reputation, RetryConfig, RetryState, Role, ThresholdStrategy, VaultMetrics,
};
...
impl VaultDAO {
    ...
    pub fn resolve_dispute(
        ...
        // Load dispute
        let mut dispute =
            storage::get_dispute(&env, dispute_id).ok_or(VaultError::DisputeNotFound)?;
